...
class Player {
  ...
  heal(player) {
    ...
    player.health += healAmount
      ...
      let diff=100-player.health
      healAmount = Math.floor(Math.random() * diff) + 1
      player.health += healAmount
    }
    else{
...
let player1 = new Player('You', 100, 10)
...
document.addEventListener('keydown', function(e) {
  ...
  if (e.key == 'q' && p2.health > 0 && !game.isOver) {// After striking then play attack sound
    p1.strike(p1, p2, p1.attackDmg)
...
document.addEventListener('keydown', function(e) {
  ...
  if (e.key == 'p' && p1.health > 0 && !game.isOver) {// After striking then play attack sound
    p2.strike(p2, p1, p2.attackDmg)
...
document.addEventListener('keydown', function(e) {
  ...
  if (e.key == 'l' && p1.health > 0  && !game.isOver) {
    p2.heal(p2)
    // After healing then play heal sound
